          ...
          <tr>
            <td style="padding: 32px;">
              ...
              <p style="margin: 0 0 24px; color: #52525b; font-size: 14px; line-height: 1.6;">
                This is a reminder for the following:
              </p>
                ...
                <tr>
                  <td style="padding: 12px 16px; background-color: #fef3c7; border-left: 4px solid #f59e0b; border-radius: 0 6px 6px 0;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="color: #92400e; font-size: 15px; font-weight: 600; padding-bottom: 4px;">${title}</td>
                      </tr>
                      ${description ? `<tr><td style="color: #78716c; font-size: 13px; padding-bottom: 4px;">${description}</td></tr>` : ""}
                      <tr>
              ...
              <table cellpadding="0" cellspacing="0" style="margin-bottom: 24px;">
                <tr>
                  <td style="background-color: #4f46e5; border-radius: 6px;">
                    <a href="${viewUrl}" style="display: inline-block; padding: 12px 24px; color: #ffffff; font-size: 14px; font-weight: 600; text-decoration: none;">View Details</a>
                  </td>
                </tr>
              </table>` : ""}
              <p style="margin: 0; color: #a1a1aa; font-size: 12px; line-height: 1.6;">
                This reminder was sent automatically via MicroCRM.
              </p>
            </td>
          </tr>
          <tr>
