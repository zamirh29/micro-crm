          ...
          <tr>
            <td style="padding: 32px;">
              ...
              <p style="margin: 0 0 24px; color: #52525b; font-size: 14px; line-height: 1.6;">
                An invoice has been generated for you. Please find the details below.
              </p>
                ...
                <tr>
                  <td style="padding: 12px 16px; background-color: #f4f4f5; border-radius: 6px;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="color: #71717a; font-size: 13px; padding-bottom: 4px;">Invoice Number</td>
                      ...
                      <tr>
                        <td style="color: #71717a; font-size: 13px; padding-bottom: 4px;">Due Date</td>
                        <td align="right" style="color: #3f3f46; font-size: 13px; font-weight: 600; padding-bottom: 4px;">${dueDate}</td>
                      </tr>
                      <tr>
                        <td style="color: #71717a; font-size: 13px;">Amount Due</td>
              ...
              <table cellpadding="0" cellspacing="0" style="margin-bottom: 24px;">
                <tr>
                  <td style="background-color: #4f46e5; border-radius: 6px;">
                    <a href="${viewUrl}" style="display: inline-block; padding: 12px 24px; color: #ffffff; font-size: 14px; font-weight: 600; text-decoration: none;">View Invoice</a>
                  </td>
                </tr>
              </table>
